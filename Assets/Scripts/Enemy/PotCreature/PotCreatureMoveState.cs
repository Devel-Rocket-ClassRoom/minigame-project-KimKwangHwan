...
public class PotCreatureMoveState : EnemyState<PotCreature>
{
    private float moveDir;
    private float moveTimer;
    private float attackMoveInterval = 0.5f;
    private float moveInterval = 2f;
    public PotCreatureMoveState(PotCreature enemy, EnemyStateMachine stateMachine) : base(enemy, stateMachine)
    {
    }
