...
public class PotCreatureHurtState : EnemyState<PotCreature>
{
    private float hurtTimer;
    public PotCreatureHurtState(PotCreature enemy, EnemyStateMachine stateMachine) : base(enemy, stateMachine)
    {
    }
