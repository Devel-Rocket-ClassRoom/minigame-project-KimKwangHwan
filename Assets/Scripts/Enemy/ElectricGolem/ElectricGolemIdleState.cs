...
public class ElectricGolemIdleState : EnemyState<ElectricGolem>
{
    private float idleTime;
    private float startIdleTime = 1f;
    private float endIdleTime = 3f;
    private float timer;
    public ElectricGolemIdleState(ElectricGolem enemy, EnemyStateMachine stateMachine) : base(enemy, stateMachine)
    {
    }
